...
def plot_topology(ax: matplotlib.axes.Axes,
                  topology: nx.Graph,
                  layout: Callable,  # good options are: nx.kamada_kawai_layout for pemsd7 and totem, nx.spring_layout for abilene
                  add_label: bool = True,
...
def plot_network_univariate_timeseries(dataset: Dataset,
...
def plot_nodes_dist_hist_for_pemsd7(dataset,
                         k: int = 3,
                         save_mod: bool = False
                         ):
